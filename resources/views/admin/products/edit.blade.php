                ...
                <div style="display:grid;grid-template-columns:1fr 1fr 80px auto;gap:8px;align-items:center;">
                    <div>
                        ...
                        <button type="button" class="color-picker-btn" data-index="${index}" style="width:100%;padding:8px;border:2px solid #d1d5db;border-radius:8px;background:#fff;cursor:pointer;display:flex;align-items:center;gap:8px;font-size:0.9rem;">
                            <span class="color-preview" style="width:24px;height:24px;border-radius:4px;background:${color || '#ccc'};display:inline-block;border:1px solid #e5e7eb;"></span>
                            <span class="color-text">${color || 'Select color'}</span>
                        </button>
                        <input type="hidden" name="color_${index}" class="color-input" value="${color}">
                    </div>
                    <input type="text" class="input" name="size_${index}" placeholder="Size (e.g., S, M, L)" value="${size}" style="padding:6px;font-size:0.9rem;">
